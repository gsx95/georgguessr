let GuessrHome = {
    ...
    init: function() {
        ...
        byId("create-room-btn").onclick = GuessrHome.showCreateRoom;
        byId("enter-room-btn").onclick = GuessrHome.showEnterRoom;
        byId("create-and-play-btn").onclick = GuessrHome.createRoom;
        byId("enter-btn").onclick = GuessrHome.enterRoom;
    ...
    createRoomList: function(data) {
        let continent = byId("continent-selector").value;
        let country = byId("country-selector").value;
        let city = byId("city-selector").value;
